		...
		<section>	
			...
			<table border="1">
				...
				<tr>
					...
					<th>
						<a href="/turno.php?action=borrar&id=<?php echo $turno["id"]; ?>">Borrar</a> | 
						<a href="/turno.php?action=editar&id=<?php echo $turno["id"]; ?>">Editar</a> | 
						<a href="/turno.php?action=visualizar&id=<?php echo $turno["id"]; ?>">Ver</a>
					</th>
				</tr>
				<?php 
					}			
